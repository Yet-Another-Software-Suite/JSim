...
import jsim.collision.BroadPhase;
import jsim.collision.CollisionPair;
import jsim.collision.ContactPoint;
import jsim.collision.NarrowPhase;
import jsim.dynamics.RigidBody;
import jsim.dynamics.RigidBodyFlags;
import jsim.forces.ForceGenerator;
import jsim.forces.GravityForce;
import jsim.solver.ImpulseSolver;
 ...
 * </ol>
 *
 * <p>The API layer ({@link jsim.api.SimWorld}) owns this object and delegates to it.
