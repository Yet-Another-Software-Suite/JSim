 ...
 * <p>Usage example:
 * <pre>{@code
 * // Wire up after creating the PhysicsWorld:
 * WorldPosePublisher publisher = new WorldPosePublisher(
 *     world.getNativeHandle(),
 *     world.getMaxBodies()
 * );
 * // Publish automatically every physics step:
 * world.addStepListener(publisher::publishFrame);
 *
 * // Or manually:
 * int count = publisher.publishFrame(); // publishes /JSim/World/bodyPoses, etc.
 *
 * // Clean up:
 * publisher.close();
 * }</pre>
