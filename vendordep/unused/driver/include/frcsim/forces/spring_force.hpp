 ...
 * @brief ForceGenerator applying a Hooke's Law spring force between two rigid
 * bodies.
 */
...
class SpringForce : public ForceGenerator {
 public:
   ...
   * @param localConnectionPoint Local position of the connection point on the
   * object.
   * @param otherConnectionPoint Local position of the connection point on the
   * other body.
   * @param springConstant The stiffness (k).
   * @param restLength The natural resting length.
   */
  SpringForce(RigidBody* otherBody, const Vector3& localConnectionPoint, const Vector3& otherConnectionPoint, double springConstant,
              double restLength);
...
inline SpringForce::SpringForce(RigidBody* otherBody, const Vector3& localConnectionPoint, const Vector3& otherConnectionPoint, double springConstant,
                                double restLength)
