...
class Cylinder : public Shape {
 public:
   ...
   * @param halfHeight Half the height of the cylinder along the Y axis in
   * meters.
   */
...
inline Cylinder::Cylinder(double radius, double halfHeight) : m_radius(radius), m_halfHeight(halfHeight) {}

inline ShapeType Cylinder::GetType() const { return ShapeType::CYLINDER; }

inline double Cylinder::CalculateVolume() const { return M_PI * m_radius * m_radius * 2.0 * m_halfHeight; }
