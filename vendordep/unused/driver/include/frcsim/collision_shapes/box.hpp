...
class Box : public Shape {
 public:
   ...
   * @param halfExtents A Vector3 where x, y, and z are half the width, height,
...
inline double Box::CalculateVolume() const { return 8.0 * m_halfExtents.x * m_halfExtents.y * m_halfExtents.z; }
