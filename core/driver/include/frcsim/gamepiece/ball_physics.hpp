 ...
 * @brief 3D rigid-body ball simulator with drag, Magnus lift, and ground contact.
 */
...
class BallPhysicsSim3D {
 public:
  ...
  struct Config {
    ...
    /// @brief Maximum internal integration substep size (seconds, clamped to [1e-4, 0.05]).
  ...
  /// @brief Foam compression stiffness in N/m (for high-density foam gamepieces).
