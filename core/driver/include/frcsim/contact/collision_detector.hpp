...
class CollisionDetector {
 public:
   ...
   */
  virtual CollisionManifold DetectCollision(const Shape* shapeA, const Vector3& posA, const Quaternion& rotA, const Shape* shapeB,
                                            const Vector3& posB, const Quaternion& rotB) = 0;
};
